...
# --- Configuration ---
TESTBENCH_FILE="src/traffic_light_tb.v"
RUN_TAG=run_final # Your run tag
USERNAME=ahmedfathy0-0 # Your username
PDK_VERSION="0fe599b2afb6708d281543108caf8310912f54af" # The specific PDK version hash

# --- Paths ---
RTL_FILE="src/traffic_light.v"
NETLIST_FILE="runs/${RUN_TAG}/06-yosys-synthesis/traffic_light.nl.v"
FINAL_NL_FILE="runs/${RUN_TAG}/final/nl/traffic_light.nl.v"
